...
('Lat Pulldown', 'Sit at a lat pulldown machine and grab the bar with a wide grip. Pull the bar down towards your chest while squeezing your shoulder blades together. Slowly return to the starting position.', 'Increase strength', 'Lats', 'strongman', 'https://wger.de/media/exercise-images/133/Decline-close-grip-bench-press-1.png', 'Barbell'), 
...
('Seated Row', 'Sit at a seated row machine with your feet on the platform and hands on the handles. Pull the handles towards your waist while keeping your back straight, then slowly return to the starting position.', 'Increase strength', 'Lats, biceps', 'strongman', 'https://wger.de/media/exercise-images/133/Decline-close-grip-bench-press-1.png', 'Barbell'), 
